...
DEFAULTS: dict[str, Any] = {
    ...
    "video": {"max_work_fps": 60, "out_fps": 30, "width": 1080, "height": 1920, "crf": 20,
              ...
              "crop_smoothing": 0.90},
    "edit": {"min_clip_s": 15, "max_clip_s": 60, "intro_s": 1.4, "outro_s": 2.6,
             "slowmo_speed": 0.5, "slowmo_window_s": 0.45, "freeze_s": 0.7,
             "peak_moments": "auto", "sparkline": True, "label_min_confidence": 0.55},
    "style": {"accent": "#E10600",
